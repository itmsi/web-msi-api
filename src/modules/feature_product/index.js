...
router.get('/', fetch)
router.get('/:feature_product_id', paramValidation, fetchByParam)
router.put('/:feature_product_id', putValidation, update)
router.delete('/:feature_product_id', softDelete)
