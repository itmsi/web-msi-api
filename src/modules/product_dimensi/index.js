...
router.get('/', fetch)
router.get('/:product_dimensi_id', paramValidation, fetchByParam)
router.put('/:product_dimensi_id', putValidation, update)
router.delete('/:product_dimensi_id', softDelete)
