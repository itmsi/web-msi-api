...
const COLUMN_DEFAULT = [
  `${TABLE}.type_product_id`, `${TABLE}.type_product_name_id`, `${TABLE}.type_product_name_en`, `${TABLE}.type_product_name_cn`,
  `${TABLE}.created_at`, `${TABLE}.created_by`, `${TABLE}.updated_at`, `${TABLE}.updated_by`,
  `${TABLE}.deleted_at`, `${TABLE}.deleted_by`
]

const DEFAULT_SORT = [`${TABLE}.type_product_id`, 'DESC']
  ...
  if (search) {
    switch (where?.language) {
      case 'id':
        ...
        break;
      case 'en':
        builder.whereILike(`${TABLE}.type_product_name_en`, `%${search}%`).andWhere(`${TABLE}.deleted_at`, null)
        break;
      case 'cn':
        builder.whereILike(`${TABLE}.type_product_name_cn`, `%${search}%`).andWhere(`${TABLE}.deleted_at`, null)
        break;
      default:
        builder.whereILike(`${TABLE}.type_product_name_id`, `%${search}%`).andWhere(`${TABLE}.deleted_at`, null)
