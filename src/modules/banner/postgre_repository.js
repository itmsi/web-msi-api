...
const COLUMN_ALL = [
  `${TABLE}.banner_id`, `${TABLE}.title_banner`, `${TABLE}.file_banner`,
  `${TABLE}.link_banner`, `${TABLE}.description_banner`,
...
const condition = (builder, where, search = null) => {
  ...
  if (search) {
    builder.whereILike(`${TABLE}.title_banner`, `%${search}%`).andWhere(`${TABLE}.deleted_at`, null)
    builder.orWhereILike(`${TABLE}.description_banner`, `%${search}%`).andWhere(`${TABLE}.deleted_at`, null)
  }
