...
router.get('/', fetch)
router.get('/:gallery_product_id', paramValidation, fetchByParam)
router.put('/:gallery_product_id', putValidation, update)
router.delete('/:gallery_product_id', softDelete)
