...
exports.up = function (knex) {
  return knex.schema.createTable('mst_feature_child_product', (table) => {
    ...
    table.string('feature_child_product_description_id', 220).nullable()
    table.string('feature_child_product_description_en', 220).nullable()
    table.string('feature_child_product_description_cn', 220).nullable()
