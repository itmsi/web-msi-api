...
exports.up = function (knex) {
  return knex.schema.createTable('mst_product_dimensi', (table) => {
    table.uuid('product_dimensi_id').defaultTo(knex.raw('uuid_generate_v4()')).primary();
    table.uuid('product_model_id').references('mst_product_model.product_model_id').nullable()
